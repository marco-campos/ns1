    ...
    <div className="container my-5">
      ...
      <div className="row">
        <div className="col-lg-8 mx-auto">
          ...
          <p>My hope is to create a platform that could be accessed by any student with the drive to excel in math competitions regardless of their access to elite coaching. I wanted the questions to be uniquely generated, high scores to be tracked, weaknesses to be recognized.</p>
