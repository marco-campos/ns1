...
// Assuming you have functions for each skill type like this:
...
console.log(skillType)
  // This function decides which generator function to use based on the skillType
  ...
  const handleSubmit = (e) => {
    ...
    const updatedScore = correct ? score + 1 : score; // You can adjust scoring as needed
    setAnswers([...answers, { ...currentQuestion, userInput: userInput.trim(), correct }]);
